...
timeout 5 ffmpeg -f v4l2 -input_format yuyv422 -video_size 640x480 -framerate 30 -i /dev/video0 -f null - 2>&1 | tail -20
echo ""
...
timeout 3 ffmpeg -f alsa -channels 1 -sample_rate 48000 -i plughw:1,0 -f null - 2>&1 | tail -10
echo ""

echo "Testing plughw:2,0 (USB Audio Device)..."
timeout 3 ffmpeg -f alsa -channels 1 -sample_rate 48000 -i plughw:2,0 -f null - 2>&1 | tail -10
echo ""
